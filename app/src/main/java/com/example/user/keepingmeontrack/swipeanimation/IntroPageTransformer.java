    ...
    public void transformPage(View page, float position) {
        ...
        if (position <= -1.0f || position >= 1.0f) {
            ...
            try {
                ...
                View financeFollow = page.findViewById(R.id.desc_text);
                financeFollow.setTranslationY(-pageWidthTimesPosition / 2f);
                financeFollow.setAlpha(1.0f - absPosition);
                // Now, we want the image to move to the right,
                // i.e. in the opposite direction of the rest of the
                // content while fading out
                View computer = page.findViewById(R.id.title2);
